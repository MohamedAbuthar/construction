    ...
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1">EVM Dashboard</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="text-2xl sm:text-3xl font-bold text-red-500 mb-2">-₹25,00,000</div>
            <span className="inline-block px-2 py-1 text-xs font-medium text-red-600 bg-red-50 rounded">
              Over Budget
            </span>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="text-2xl sm:text-3xl font-bold text-red-500 mb-2">-₹30,00,000</div>
            <span className="inline-block px-2 py-1 text-xs font-medium text-red-600 bg-red-50 rounded">
              Over Budget
            </span>
          </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-6">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-1">Portfolio Summary</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div>
              ...
              <div className="text-xl sm:text-2xl font-bold text-gray-900">₹2,80,00,000</div>
            </div>
            <div>
              <div className="text-sm text-gray-600 mb-2">Earned Value (EV)</div>
              <div className="text-xl sm:text-2xl font-bold text-gray-900">₹2,50,00,000</div>
            </div>
            <div>
              <div className="text-sm text-gray-600 mb-2">Actual Cost (AC)</div>
              <div className="text-xl sm:text-2xl font-bold text-gray-900">₹2,75,00,000</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-6">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-1">Project Performance Indices</h2>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-1">Project Breakdown</h2>
          <p className="text-sm text-gray-500 mb-6">Individual project EVM metrics</p>
          
          {/* Project Card */}
          <div className="border border-gray-200 rounded-lg p-4 sm:p-6 hover:bg-blue-300">
            <div className="flex items-start justify-between mb-4">
              ...
              <ExternalLink
                className="w-5 h-5 text-gray-400 cursor-pointer hover:text-gray-600 flex-shrink-0"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
              <div>
                ...
                <div className="text-base sm:text-lg font-bold text-gray-900 mb-1">0.91</div>
              ...
              <div>
                ...
                <div className="text-base sm:text-lg font-bold text-gray-900 mb-1">0.89</div>
                <span className="inline-block px-2 py-0.5 text-xs font-medium text-red-600 bg-red-50 rounded">
                  Behind
                </span>
              </div>
              ...
              <div>
                ...
                <div className="text-base sm:text-lg font-bold text-gray-900 break-all">₹2,80,00,000</div>
              </div>
              
              <div>
                <div className="text-xs text-gray-600 mb-1">EV</div>
                <div className="text-base sm:text-lg font-bold text-gray-900 break-all">₹2,50,00,000</div>
              </div>
              
              <div>
                <div className="text-xs text-gray-600 mb-1">AC</div>
                <div className="text-base sm:text-lg font-bold text-gray-900 break-all">₹2,75,00,000</div>
              </div>
              
              <div>
                <div className="text-xs text-gray-600 mb-1">CV</div>
                <div className="text-base sm:text-lg font-bold text-red-600 break-all">-₹25,00,000</div>
              </div>
            </div>
          </div>
        </div>
